        	...
        	<div class="container">
        		<div class="row">
	        		<div class="col-sm-12 wow fadeInLeftBig">
	            		<h1><span class="violet">Miranda Fotografia</span> Filmagens, fotopresentes, revelações, albuns encadernados.</h1>
	            ...
	            <div class="row">
	                <div class="col-sm-12 testimonial-list">
	                	<div class="col-sm-offset-3 col-sm-2 ">
	                	 <img src="assets/img/album-img/apoio/bergamini.png">
	                    </div>
	                    <div class="col-sm-offset-2 col-sm-2 ">
	                	 <img src="assets/img/album-img/apoio/Take7.jpg">
	                    </div>
	                </div>
	            </div>
	        </div>
